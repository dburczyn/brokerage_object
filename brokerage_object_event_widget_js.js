...
//     // create front tile
//     $('#' + eventtileinstance.indexfilename + this.constructor.name + 'container').append(
//         $('<div/>')
...
//     $('#' + this.updatedat).on('click', function (e) {
...
//         $.ajax({
//                 url: eventtileinstance.indexurl + "/" + $(this).attr('id'),
//                 beforeSend: setAuthHeader.bind(eventtileinstance),
//                 dataType: 'json',
...
//     $('#' + eventtileinstance.indexfilename + this.constructor.name).on('click', function (e) {
